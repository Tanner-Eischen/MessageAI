...
BEGIN
  ...
  -- ============================================================
  -- Use deterministic UUIDs based on user_id for idempotency
  v_conv_boss := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':conv:boss');
  ...
  VALUES 
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:p1'), v_conv_boss, v_user_id, v_two_weeks),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:p2'), v_conv_boss, v_boss_id, v_two_weeks);
  
  -- Long conversation history (for RAG context - 15+ messages)
  -- Week 2: Initial onboarding
  v_msg1 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m1');
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m2'), v_conv_boss, v_user_id,
    'Thanks! Yes, I should be able to get those done by Friday.',
    v_two_weeks + INTERVAL '30 minutes', v_two_weeks + INTERVAL '30 minutes');
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m3'), v_conv_boss, v_boss_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m4'), v_conv_boss, v_user_id,
    'Got it, I''ll be there!',
    v_two_weeks + INTERVAL '50 minutes', v_two_weeks + INTERVAL '50 minutes');
  
  -- Week 2: Missed standup incident
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m5'), v_conv_boss, v_boss_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m6'), v_conv_boss, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m7'), v_conv_boss, v_boss_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m8'), v_conv_boss, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m9'), v_conv_boss, v_boss_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m10'), v_conv_boss, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m11'), v_conv_boss, v_boss_id,
    'The client really liked your presentation last week. Nice work on the animations.',
    v_last_week, v_last_week);
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m12'), v_conv_boss, v_user_id,
    'Thank you! I spent a lot of time on those.',
    v_last_week + INTERVAL '10 minutes', v_last_week + INTERVAL '10 minutes');
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m13'), v_conv_boss, v_boss_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m14'), v_conv_boss, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m15'), v_conv_boss, v_boss_id,
  ...
  v_msg2 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:rsd1');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  v_msg3 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:rsd2');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  INSERT INTO follow_up_items (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:fu1'),
    v_user_id, v_conv_boss, v_msg2,
  ...
  INSERT INTO follow_up_items (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:fu2'),
    v_user_id, v_conv_boss, v_msg3,
  ...
  INSERT INTO relationship_profiles (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:rel'),
    v_user_id, v_conv_boss,
  ...
  -- ============================================================
  v_conv_friend := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':conv:friend');
  ...
  INSERT INTO conversation_participants (id, conversation_id, user_id, joined_at)
  VALUES 
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:p1'), v_conv_friend, v_user_id, v_two_weeks - INTERVAL '1 day'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:p2'), v_conv_friend, v_friend_id, v_two_weeks - INTERVAL '1 day');
  
  -- Long conversation with various topics (RAG showcase - 25+ messages)
  -- Week 2: TV show discussion
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m1'), v_conv_friend, v_friend_id,
    'omg did you see the new episode last night?? 🤯',
    v_two_weeks, v_two_weeks);
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m2'), v_conv_friend, v_user_id,
    'YES! That plot twist was insane!',
    v_two_weeks + INTERVAL '3 minutes', v_two_weeks + INTERVAL '3 minutes');
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m3'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m4'), v_conv_friend, v_user_id,
    'Absolutely! Saturday work for you?',
    v_two_weeks + INTERVAL '9 minutes', v_two_weeks + INTERVAL '9 minutes');
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m5'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m6'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m7'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m8'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m9'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m10'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m11'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m12'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m13'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m14'), v_conv_friend, v_friend_id,
    'Saturday is perfect! How''s work going btw? You seemed stressed last week.',
    v_last_week, v_last_week);
  
  v_msg4 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m15');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m16'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m17'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m18'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m19'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m20'), v_conv_friend, v_friend_id,
    'Brew Haven? Yeah why?',
    v_last_week + INTERVAL '2 days 3 minutes', v_last_week + INTERVAL '2 days 3 minutes');
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m21'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m22'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m23'), v_conv_friend, v_friend_id,
    'Hey did you end up buying that game you were obsessing over?',
    v_last_week + INTERVAL '4 days', v_last_week + INTERVAL '4 days');
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m24'), v_conv_friend, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m25'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m26'), v_conv_friend, v_user_id,
  ...
  v_msg5 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m27');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  v_msg6 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m28');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m29'), v_conv_friend, v_friend_id,
  ...
  INSERT INTO relationship_profiles (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:rel'),
    v_user_id, v_conv_friend,
  ...
  -- ============================================================
  v_conv_mom := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':conv:mom');
  ...
  INSERT INTO conversation_participants (id, conversation_id, user_id, joined_at)
  VALUES 
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:p1'), v_conv_mom, v_user_id, v_two_weeks - INTERVAL '5 days'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:p2'), v_conv_mom, v_mom_id, v_two_weeks - INTERVAL '5 days');
  
  -- Messages with caring but potentially anxiety-inducing content
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m1'), v_conv_mom, v_mom_id,
    'Hi honey! Just checking in. How are you doing?',
    v_last_week, v_last_week);
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m2'), v_conv_mom, v_user_id,
    'Hey Mom! I''m good, just busy with work.',
    v_last_week + INTERVAL '1 hour', v_last_week + INTERVAL '1 hour');
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m3'), v_conv_mom, v_mom_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m4'), v_conv_mom, v_user_id,
  ...
  v_msg7 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m5');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  v_msg8 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m6');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  INSERT INTO follow_up_items (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:fu1'),
    v_user_id, v_conv_mom, v_msg7,
  ...
  INSERT INTO follow_up_items (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:fu2'),
    v_user_id, v_conv_mom, v_msg8,
  ...
  INSERT INTO relationship_profiles (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:rel'),
    v_user_id, v_conv_mom,
  ...
  -- ============================================================
  v_conv_client := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':conv:client');
  ...
  INSERT INTO conversation_participants (id, conversation_id, user_id, joined_at)
  VALUES 
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:p1'), v_conv_client, v_user_id, v_last_week),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:p2'), v_conv_client, v_client_id, v_last_week);
  
  -- Professional conversation
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m1'), v_conv_client, v_client_id,
    'Hi! Thanks for taking on this project. We''re excited to work with you.',
    v_last_week, v_last_week);
  
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m2'), v_conv_client, v_user_id,
  ...
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m3'), v_conv_client, v_client_id,
  ...
  v_msg9 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m4');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  v_msg10 := uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m5');
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  ...
  INSERT INTO follow_up_items (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:fu1'),
    v_user_id, v_conv_client, v_msg9,
  ...
  INSERT INTO follow_up_items (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:fu2'),
    v_user_id, v_conv_client, v_msg10,
  ...
  INSERT INTO action_items (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:ai1'),
  ...
  INSERT INTO relationship_profiles (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:rel'),
    v_user_id, v_conv_client,
  ...
  INSERT INTO conversation_context_cache (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':cache:boss'),
    v_user_id, v_conv_boss,
  ...
  INSERT INTO conversation_context_cache (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':cache:friend'),
    v_user_id, v_conv_friend,
  ...
  INSERT INTO conversation_context_cache (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':cache:mom'),
    v_user_id, v_conv_mom,
    'Family check-ins and life updates',
    '["Aunt Linda''s birthday party next month", "Mom cares deeply but can be overwhelming"]'::jsonb,
    '["Dentist appointment still pending"]'::jsonb,
    NOW(), NOW() + INTERVAL '24 hours'
  );
  ...
  INSERT INTO conversation_context_cache (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':cache:client'),
    v_user_id, v_conv_client,
  ...
  INSERT INTO safe_topics (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':topic:boss:design'),
    v_user_id, v_conv_boss,
  ...
  INSERT INTO safe_topics (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':topic:friend:tv'),
    v_user_id, v_conv_friend,
  ...
  INSERT INTO safe_topics (
    ...
    uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':topic:friend:tech'),
    v_user_id, v_conv_friend,
  ...
  -- ============================================================
  -- EXTENDED SEED DATA: Additional messages for filter showcase
  -- ============================================================
  
  -- Add more unanalyzed messages to boss conversation (no tone badges)
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES 
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m16'), v_conv_boss, v_boss_id, 'Do you have the latest metrics?', v_now - INTERVAL '30 minutes', v_now - INTERVAL '30 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m17'), v_conv_boss, v_user_id, 'I''ll get them for you by EOD', v_now - INTERVAL '25 minutes', v_now - INTERVAL '25 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':boss:m18'), v_conv_boss, v_boss_id, 'Great, thanks. Also need Q4 planning docs.', v_now - INTERVAL '20 minutes', v_now - INTERVAL '20 minutes');
  
  -- Add more unanalyzed messages to friend conversation (no tone badges)
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m30'), v_conv_friend, v_friend_id, 'Did you finish that book yet?', v_now - INTERVAL '15 minutes', v_now - INTERVAL '15 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m31'), v_conv_friend, v_user_id, 'Almost done! It''s so good', v_now - INTERVAL '12 minutes', v_now - INTERVAL '12 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m32'), v_conv_friend, v_friend_id, 'Right? The twist at the end was insane', v_now - INTERVAL '10 minutes', v_now - INTERVAL '10 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':friend:m33'), v_conv_friend, v_user_id, 'No spoilers but YES', v_now - INTERVAL '8 minutes', v_now - INTERVAL '8 minutes');
  
  -- Add more messages to mom conversation (no tone badges)
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m7'), v_conv_mom, v_mom_id, 'How was your day honey?', v_now - INTERVAL '2 hours', v_now - INTERVAL '2 hours'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m8'), v_conv_mom, v_user_id, 'Pretty good! Got a lot done', v_now - INTERVAL '1 hour 55 minutes', v_now - INTERVAL '1 hour 55 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m9'), v_conv_mom, v_mom_id, 'That''s wonderful sweetheart', v_now - INTERVAL '1 hour 50 minutes', v_now - INTERVAL '1 hour 50 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':mom:m10'), v_conv_mom, v_user_id, 'Thanks for asking!', v_now - INTERVAL '1 hour 45 minutes', v_now - INTERVAL '1 hour 45 minutes');
  
  -- Add more messages to client conversation (no tone badges)
  INSERT INTO messages (id, conversation_id, sender_id, body, created_at, updated_at)
  VALUES
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m6'), v_conv_client, v_client_id, 'When can we schedule the design review?', v_now - INTERVAL '3 hours', v_now - INTERVAL '3 hours'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m7'), v_conv_client, v_user_id, 'How about Thursday at 2pm?', v_now - INTERVAL '2 hours 50 minutes', v_now - INTERVAL '2 hours 50 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m8'), v_conv_client, v_client_id, 'Perfect! I''ll send the agenda tomorrow', v_now - INTERVAL '2 hours 45 minutes', v_now - INTERVAL '2 hours 45 minutes'),
    (uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, v_user_id::text || ':client:m9'), v_conv_client, v_user_id, 'Sounds good, looking forward to it', v_now - INTERVAL '2 hours 40 minutes', v_now - INTERVAL '2 hours 40 minutes');
  ...
  RAISE NOTICE '   • 4 conversation context caches';
  ...
  RAISE NOTICE '   • Mom conversation: 10+ messages with family updates';
  RAISE NOTICE '   • Client conversation: 9+ messages with professional context';
  ...
  RAISE NOTICE '   );';
  RAISE NOTICE '';
  RAISE NOTICE '✨ Idempotent UUIDs enabled:';
  RAISE NOTICE '   • All conversation IDs are deterministic and based on user_id';
  RAISE NOTICE '   • Running the script multiple times produces consistent data';
  RAISE NOTICE '   • Safe for production seeding workflows';
  RAISE NOTICE '';
